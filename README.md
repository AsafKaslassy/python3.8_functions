...
- [x] [Simple List Average](archive/types/simple_list_avg-13975.py)
- [x] [Hexadecimal, Octal and Binary Representations](/archive/types/hex-oct-dec_representations-5150.py)
- [x] [The input Function](archive/types/the_input_func-5155.py)
  * [Issue](/QA/12.12.2019%20-%20questions.md)
...
- [ ] [Sum of Two Numbers Lambda Expression](/archive/functions/sum_of_two_numbers_lambda_expression-13997.py)
...
#### Classes
- [x] [Simple Circle Class](/seminars/object_oriented/classes_assignments/simple_circle_class-13543.py)
- [x] [Simple Rectangle Class](/seminars/object_oriented/classes_assignments/simple_rectangle_class-13544.py)
- [x] [List of Students](/seminars/object_oriented/classes_assignments/list_of_students-13545.py)
- [x] [Simple Car Class](/seminars/object_oriented/classes_assignments/simple_car_class-13546.py)
...
- [x] [Total Area of Shapes](/seminars/object_oriented/classes_assignments/total_area_of_shapes-13557.py)
- [ ] [Country Assignment](/seminars/object_oriented/classes_assignments/)
- [ ] [List of Friends](/seminars/object_oriented/classes_assignments/)
- [ ] [School Assignment](/seminars/object_oriented/classes_assignments/)
- [ ] [Person Assignment](/seminars/object_oriented/classes_assignments/)
- [ ] [Student Assignment](/seminars/object_oriented/classes_assignments/)
- [ ] [The __str__ Magic Method](/seminars/object_oriented/classes_assignments/)
- [ ] [Operators Overloading](/seminars/object_oriented/classes_assignments/)
- [ ] [The repr() Function](/seminars/object_oriented/classes_assignments/)
- [ ] [BankAccount Operators Overloading](/seminars/object_oriented/classes_assignments/)
- [ ] [List of Students Marks](/seminars/object_oriented/classes_assignments/)
...
#### Files
Note: Files also performed in 'types' topic.
- [ ] []()
